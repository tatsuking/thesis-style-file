...
\documentclass[technicalreport]{thesis}
%\usepackage{graphicx}
...
\etitle{How to Use \LaTeXe\ Class File (\ version ) }
%\esubtitle{Guide to the Technical Report and Template}
\authorlist{%
 \authorentry[福田　龍樹]{5300}{電制 花子}% 
}
%
\begin{document}
\begin{jabstract}
電子情報通信学会技術研究報告原稿用の p\LaTeXe\ クラスファイル，
{}（\texttt{version }）の使い方を説明します．
...
a p\LaTeXe\ class file, named \ (ver.\,), 
